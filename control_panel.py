...
class ControlPanel(Gtk.Box):
    def __init__(self, stream_manager, video_widget):
        ...
        btn_reset.connect("clicked", lambda b: self.crop_controller.reset_crop() or entry.set_text("0"))
        ...
        def on_plus_clicked(_):
            if self.crop_controller.zoom_percent < 100:
                ...
                self.crop_controller.set_zoom_percent(100)
        ...
        def on_minus_clicked(_):
            if self.crop_controller.zoom_percent > 0:
                ...
                self.crop_controller.set_zoom_percent(0)
        ...
        def on_entry_activated(_):
            try:
                ...
                entry.set_text(str(self.crop_controller.zoom_percent))  # Clamp display
            except ValueError:
                entry.set_text(str(self.crop_controller.zoom_percent))
